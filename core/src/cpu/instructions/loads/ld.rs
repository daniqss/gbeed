...
impl LdR8R8 {
    pub fn new(dst: R8, src: R8) -> StaticBox<Self> { StaticBox::new(Self { dst, src }) }
}
...
impl LdR8Imm8 {
    pub fn new(dst: R8, val: u8) -> StaticBox<Self> { StaticBox::new(Self { dst, val }) }
}
...
impl LdR16Imm16 {
    pub fn new(dst: R16, val: u16) -> StaticBox<Self> { StaticBox::new(Self { dst, val }) }
}
...
impl LdSPImm16 {
    pub fn new(val: u16) -> StaticBox<Self> { StaticBox::new(Self { val }) }
}
...
impl LdHLSPPlusImm8 {
    pub fn new(e8: i8) -> StaticBox<Self> { StaticBox::new(Self { e8 }) }
}
