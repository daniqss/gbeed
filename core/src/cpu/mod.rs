...
impl Cpu {
    ...
    pub fn fetch(gb: &mut Dmg, opcode: u8) -> FetchResult {
        ...
        let instruction: InstructionBox<dyn Instruction> = match opcode {
            ...
            0x04 => IncR8::new(R8::B),
            0x05 => DecR8::new(R8::B),
            0x06 => LdR8Imm8::new(R8::B, gb.read(cpu.pc.wrapping_add(1))),
            0x07 => Rlca::new(),
            0x08 => LdImm16SP::new(gb.load(cpu.pc.wrapping_add(1))),
            0x09 => AddR16::new(R16::BC),
            0x0A => LdAPointedByR16::new(R16::BC),
            0x0B => DecR16::new(R16::BC),
            0x0C => IncR8::new(R8::C),
            0x0D => DecR8::new(R8::C),
            0x0E => LdR8Imm8::new(R8::C, gb.read(cpu.pc.wrapping_add(1))),
            0x0F => Rrca::new(),
            0x10 => Stop::new(),
            0x11 => LdR16Imm16::new(R16::DE, gb.load(cpu.pc.wrapping_add(1))),
            0x12 => LdPointedByR16A::new(R16::DE),
            0x13 => IncR16::new(R16::DE),
            0x14 => IncR8::new(R8::D),
            0x15 => DecR8::new(R8::D),
            0x16 => LdR8Imm8::new(R8::D, gb.read(cpu.pc.wrapping_add(1))),
            0x17 => Rla::new(cpu.carry()),
            0x18 => Jr::new(JC::None, gb.read(cpu.pc.wrapping_add(1))),
            0x19 => AddR16::new(R16::DE),
            0x1A => LdAPointedByR16::new(R16::DE),
            0x1B => DecR16::new(R16::DE),
            0x1C => IncR8::new(R8::E),
            0x1D => DecR8::new(R8::E),
            0x1E => LdR8Imm8::new(R8::E, gb.read(cpu.pc.wrapping_add(1))),
            0x1F => Rra::new(cpu.carry()),
            0x20 => Jr::new(JC::NotZero(cpu.not_zero()), gb.read(cpu.pc.wrapping_add(1))),
            0x21 => LdR16Imm16::new(R16::HL, gb.load(cpu.pc.wrapping_add(1))),
            0x22 => LdPointedByHLIncA::new(),
            0x23 => IncR16::new(R16::HL),
            0x24 => IncR8::new(R8::H),
            0x25 => DecR8::new(R8::H),
            0x26 => LdR8Imm8::new(R8::H, gb.read(cpu.pc.wrapping_add(1))),
            0x27 => Daa::new(),
            0x28 => Jr::new(JC::Zero(cpu.zero()), gb.read(cpu.pc.wrapping_add(1))),
            0x29 => AddR16::new(R16::HL),
            0x2A => LdAPointedByHLInc::new(),
            0x2b => DecR16::new(R16::HL),
            0x2C => IncR8::new(R8::L),
            0x2D => DecR8::new(R8::L),
            0x2E => LdR8Imm8::new(R8::L, gb.read(cpu.pc.wrapping_add(1))),
            0x2F => Cpl::new(),
            0x30 => Jr::new(JC::NotCarry(cpu.not_carry()), gb.read(cpu.pc.wrapping_add(1))),
            0x31 => LdSPImm16::new(gb.load(cpu.pc.wrapping_add(1))),
            0x32 => LdPointedByHLDecA::new(),
            0x33 => IncStackPointer::new(),
            0x34 => IncPointedByHL::new(),
            0x35 => DecPointedByHL::new(),
            0x36 => LdPointedByHLImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0x37 => Scf::new(),
            0x38 => Jr::new(JC::Carry(cpu.carry()), gb.read(cpu.pc.wrapping_add(1))),
            0x39 => AddHLSP::new(),
            0x3A => LdAPointedByHLDec::new(),
            0x3B => DecStackPointer::new(),
            0x3C => IncR8::new(R8::A),
            0x3D => DecR8::new(R8::A),
            0x3E => LdR8Imm8::new(R8::A, gb.read(cpu.pc.wrapping_add(1))),
            ...
            0xC1 => Pop::new(R16::BC),
            0xC2 => JpToImm16::new(JC::NotZero(cpu.not_zero()), gb.load(cpu.pc.wrapping_add(1))),
            0xC3 => JpToImm16::new(JC::None, gb.load(cpu.pc.wrapping_add(1))),
            0xC4 => Call::new(JC::NotZero(cpu.not_zero()), gb.load(cpu.pc.wrapping_add(1))),
            0xC5 => Push::new(R16::BC),
            0xC6 => AddImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xC7 => Rst::new(0x00),
            ...
            0xCE => AdcImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xCF => Rst::new(0x08),
            0xD0 => Ret::new(JC::NotCarry(cpu.not_carry())),
            0xD1 => Pop::new(R16::DE),
            0xD2 => JpToImm16::new(JC::NotCarry(cpu.not_carry()), gb.load(cpu.pc.wrapping_add(1))),
            0xD3 => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xD4 => Call::new(JC::NotCarry(cpu.not_carry()), gb.load(cpu.pc.wrapping_add(1))),
            0xD5 => Push::new(R16::DE),
            0xD6 => SubImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xD7 => Rst::new(0x10),
            0xD8 => Ret::new(JC::Carry(cpu.carry())),
            0xD9 => Reti::new(),
            0xDA => JpToImm16::new(JC::Carry(cpu.carry()), gb.load(cpu.pc.wrapping_add(1))),
            0xDB => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xDC => Call::new(JC::Carry(cpu.carry()), gb.load(cpu.pc.wrapping_add(1))),
            0xDD => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xDE => SbcImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xDF => Rst::new(0x18),
            0xE0 => LdhImm8A::new(gb.read(cpu.pc.wrapping_add(1))),
            0xE1 => Pop::new(R16::HL),
            0xE2 => LdhCA::new(),
            ...
            0xE6 => AndImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xE7 => Rst::new(0x20),
            0xE8 => AddSPImm8::new(gb.read(cpu.pc.wrapping_add(1)) as i8),
            0xE9 => JpToHL::new(cpu.hl()),
            0xEA => LdPointedByImm16A::new(gb.load(cpu.pc.wrapping_add(1))),
            ...
            0xEE => XorImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xEF => Rst::new(0x28),
            0xF0 => LdhAImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xF1 => Pop::new(R16::AF),
            0xF2 => LdhAC::new(),
            0xF3 => Di::new(),
            0xF4 => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xF5 => Push::new(R16::AF),
            0xF6 => OrImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xF7 => Rst::new(0x30),
            0xF8 => LdHLSPPlusImm8::new(gb.read(cpu.pc.wrapping_add(1)) as i8),
            0xF9 => LdSPHL::new(),
            0xFA => LdAPointedByImm16::new(gb.load(cpu.pc.wrapping_add(1))),
            0xFB => Ei::new(),
            0xFC => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xFD => return Err(InstructionError::UnusedOpcode(opcode, cpu.pc)),
            0xFE => CpImm8::new(gb.read(cpu.pc.wrapping_add(1))),
            0xFF => Rst::new(0x38),
        };
