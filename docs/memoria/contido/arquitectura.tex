...
Ademáis explicarase o rol doutros compoñentes fundamentais para o seu funcionamento que son implementados
...
A pesar de ser nomeado como \acrfull{cpu}, por exemplo no seu encapsulado,
este chip ademais da propia \acrshort{cpu} inclúe varias memorias e diferentes periféricos, ocupando
a \acrshort{cpu} sóamente unha pequena porción do silicio.
...
procesamento de audio (\acrshort{apu}), os temporizadores, o controlador do joypad e o contralador de interrupcións.
...
O seu cometido e preparar o sistema para a execución do programa principal provido polo cartucho.
Para iso inicializa varias zonas de memoria e rexistros dos periféricos.
Visualmente, amosa por pantalla unha sinxela animación co logotipo de Nintendo desplazandose ata 
o medio da pantalla e reproduce un son característico. Esta animación cumple tamén unha
función de proteción antipiratería.
Os xogos comerciais e validados por Nintendo requerían incluir na cabeceira da súa \acrshort{rom} unha copia
do logo de Nintendo. Durante a execución da Boot \acrshort{rom} realízase unha comparación entre os assets
...
Os distribuidores de cartuchos non autorizados afrontaban unha dobre penalización, xa que ao ter que incluir
o logo de Nintendo caían nunha dobre infracción: infracción de marca rexistrada e infracción dos dereitos de autor.
