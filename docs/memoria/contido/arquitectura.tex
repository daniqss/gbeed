...
\lettrine{N}{este} capítulo descríbense os diferentes compoñentes hardware da consola,
a súa interacción e o mapa de memoria que emprega.
Ademais explícase o rol doutros compoñentes fundamentais para o seu funcionamento que son implementados
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.70\textwidth]{imaxes/arch_diagram.png}
...
conflito. O caso máis representativo é o acceso á \acrshort{vram} e á \acrshort{oam} por parte da \acrshort{ppu}
Mentres a \acrshort{ppu} está a debuxar unha liña, a \acrshort{cpu} non pode acceder a esas memorias e calquera
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.65\textwidth]{imaxes/memory_map.png}
...
se fala de ciclos M (\textit{M-cycle}) para referirse á unidade equivalente a catro ciclos T.
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=1\textwidth]{imaxes/decap_sm83.jpg}
...
que corrixe o resultado dunha suma ou resta para que sexa válido en representación \acrfull{bcd}.
...
O SM83 é un procesador \acrfull{cisc} de lonxitude de instrución variable entre un e tres bytes,
sendo o primeiro o \gls{opcode}
e os seguintes, se os houbese, o operando inmediato de 8 ou 16 bits.
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=.95\textwidth]{imaxes/sm83_instruction_set.png}
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.55\textwidth]{imaxes/cpu_comparation.png}
...
O que non herda se do Z80 é moito máis amplo.
...
unha dirección fixa no comezo da \acrshort{rom}, separadas oito bytes entre si,
...
que habilita ou deshabilita globalmente a atención de interrupcións mediante
as instrucións \texttt{ei} e \texttt{di} respectivamente.
...
A alternativa para modificar a \acrshort{oam} é a \acrfull{dma}.
...
datos e o código do xogo xa que poden estender as capacidades da consola incorporando memoria
...
podíanse empregar \acrshortpl{rom} de ata 8\,MiB.
...
hardware a desmapee permanentemente e deixe visible a \acrshort{rom} do cartucho nese rango inicial.
...
esenciais para coñecer o tipo de cartucho, e a si ser capaz de emulalo correctamente.
...
O mecanismo aproveita esas escrituras na \acrshort{rom} como canle de control, almacenando o dato nun
...
O MBC5 permite controlar un motor de vibración, 
...
xa que depende por completo da consola que o xera, podendo deixar indefinidamente agardando á consola escrava polo seguinte bit.
Por isto, os programas deben implementar por si mesmos un temporizador
...
\begin{figure}[hp!]
  \centering
  \includegraphics[width=0.7\textwidth]{imaxes/apu_details.png}
