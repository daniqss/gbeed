...
A maior parte de funcionalidades da consola é implementada nun só \acrshort{soc}.
...
Consiste na copia automaticamente 160 bytes desde calquera páxina de memoria
...
\texttt{0x9800} e \texttt{0x9C00}, e cada capa escolle o que vai emprega mediante un bit
...
a \acrshort{vram}, permitindo crear efectos de desplazamento como podemos ver
...
\begin{table}[htbp]
  ...
  \multirow{6}{*}{\textit{Atributos}} & \textbf{Bit} & \\
                        ...
                        & 6                           & Reflexión no eixo vertical. \\
                        & \cellcolor{udcgray!25} 5    & \cellcolor{udcgray!25} Reflexión no eixo horizontal. \\
                        & 4                           & Indica se se emprega as paletas \texttt{OBP0} ou \texttt{OBP1}. \\
...
Durante o modo 3 da \acrshort{ppu}, esta dúas colas independentes de ata dezaseis píxeles,
...
que era todo o que podía direcionar a consola directamente. Co hardware adicional dos \acrshort{mbc},
podianse empregar \acrshort{rom} de ata 8\,MiB. 
...
\begin{lstlisting}[language={[x86masm]Assembler}, label={lst:bootrom-unmap}]
  ; últimas instrucions da Boot ROM
  ld a, $01
  ldh [$50], a

  ; primeiras instrucións de calqueira cartucho,
...
\begin{table}[htbp]
  ...
  Outras & --- & --- & MBC6, MBC7, MMM01, HuC3, e Pocket Camera \\
  \end{tabular}
...
consecutivos no rango \texttt{FF04--FF07}.
