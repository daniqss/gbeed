...
\begin{figure}
  \centering
  \includegraphics[width=.85\textwidth]{imaxes/raylib_architecture_v6.0.png}
...
a Raspberry Pi Zero e o navegador web.
...
e o binario resultante enlázase con \textit{glibc} e co backend X11 de raylib.
