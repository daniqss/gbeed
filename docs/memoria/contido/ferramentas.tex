...
cun crate central co núcleo do emulador e crates separados para cada interface,
...
Raylib~\cite{Raylib}
% cita entrevista eric leyendas y videojuegos?
...
que non chaman directamente á \acrshort{api} gráfica do sistema,
...
raylib pode renderizar mediante OpenGL ES sobre o subsistema \acrshort{drm} de Linux,
...
o que permite que as interfaces do emulador compilen para escritorio, web e embebidos
...
A pesar de que neste traballo non se aproveita a súa capacidade para a programación concorrente,
