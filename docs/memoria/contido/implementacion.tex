...
No listado~\ref{lst:cartridge-header} amósase a estrutura resultante xunto cunha das enumeracións que emprega,
\texttt{CartridgeType}, que recolle o hardware dispoñible no cartucho.

\begin{figure}[tbp]
\centering
\begin{minipage}[t]{0.48\textwidth}
\begin{lstlisting}[language=Rust, basicstyle=\ttfamily\tiny, linewidth=\linewidth, xleftmargin=14pt]
...
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
\begin{lstlisting}[language=Rust, basicstyle=\ttfamily\tiny, linewidth=\linewidth, xleftmargin=14pt, firstnumber=last]
...
pub enum CartridgeType {
    ...
    Mbc5Rumble, Mbc5RumbleRam, Mbc5RumbleRamBattery,
...
\end{lstlisting}
\end{minipage}
\captionof{lstlisting}{Estrutura da cabeceira do cartucho e enumeración do seu tipo de hardware}
\label{lst:cartridge-header}
\end{figure}
