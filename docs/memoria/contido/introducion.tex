...
\lettrine{A}{} familia de consolas Game Boy é unha das máis populares e de maior éxito da historia dos videoxogos. Ata 2020 seguiuse producindo hardware capaz de executar de forma nativa xogos da familia Advance, a Nintendo 3DS.
O seu percorrido e éxito son, polo tanto, longos, e a súa influencia na industria dos videoxogos e na cultura popular é indiscutible.
...
que quintuplicou a súa meta inicial de financiamento~\cite{jettriderminihero}.

Para satisfacer a demanda do público polos xogos desta consola e para a preservación da súa herdanza cultural, a ferramenta principal é a emulación.

\section{Contexto e motivación}
\label{sec:contexto}

A emulación é unha técnica que permite a execución de software deseñado para unha plataforma nunha plataforma diferente,
mediante un software que reproduce o comportamento do hardware orixinal,
de tal forma que o software orixinal non se percate de sobre onde se está executando. 

Existe unha gran cantidade de emuladores de Game Boy, para diferentes plataformas e con diferentes características, tanto propietarios como libres e de código aberto.
Todos estes emuladores empregan como base documental a gran cantidade de documentación producida pola comunidade a través da análise do hardware mediante enxeñería inversa.

Grazas a este formidable traballo da comunidade,
...
Por unha banda, persegue unha finalidade didáctica:
...
Por outra banda, propón unha finalidade técnica: ofrecer unha solución que poida ser integrada de forma doada en distintos contextos,
con especial atención á súa execución en sistemas embebidos de recursos limitados.
A partir dese núcleo de emulación, o traballo materialízase nunha consola portátil \acrfull{diy} de referencia
...
\begin{itemize}
    \item Desenvolver un emulador do modelo orixinal de Game Boy, o DMG-01 (\acrlong{dmg}).
    \item Validar os seus compoñentes fundamentais contra un conxunto de probas de referencia amplamente usado pola comunidade.
    ...
    \item Deseñar e desenvolver unha interface axeitada para o seu uso en contornas embebidas.
    \item Optimizar o proxecto para asegurar a súa correcta execución en contornas de recursos limitados.
...
\begin{enumerate}
    ...
    \item \textbf{Probas e validación}: describirase o proceso de proba e validación do emulador e os resultados obtidos.
    \item \textbf{Conclusión e traballo futuro}: expoñeranse a aprendizaxe adquirida durante o desenvolvemento do proxecto e a súa relación co grao. Abordaranse as liñas de traballo futuro para a continuación do desenvolvemento.
\end{enumerate}
