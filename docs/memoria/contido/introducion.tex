...
% liñas mestras do trballo, os obxectivos, etc. Incluimos un par de
...
Por outra banda, propón unha finalidade técnica: ofrecer unha solución en forma de librería poida ser integrada de forma doada en distintos contextos,
con especial atención á súa execución en sistemas embebidos,
permitindo o seu uso en contornas con recursos limitados.
...
\begin{enumerate}
    ...
    \item \textbf{Arquitectura da consola}: describirase a arquitectura da consola, os seus compoñentes e o seu funcionamento.
