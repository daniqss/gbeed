...
impl Cpu {
    ...
    pub fn fetch(gb: &mut Dmg, opcode: u8) -> FetchResult {
        ...
        let instruction: Box<dyn Instruction> = match opcode {
            0x00 => Nop::new(),
            0x01 => Ld::new(ID::Reg16(R16::BC), IT::Imm16(gb.load(cpu.pc + 1))),
            ...
            0x06 => Ld::new(ID::Reg8(R8::B), IT::Imm8(gb.read(cpu.pc + 1))),
            0x07 => Rlca::new(),
            0x08 => Ld::new(ID::PointedByN16(gb.load(cpu.pc + 1)), IT::StackPointer(cpu.sp)),
            0x09 => Add::new(ID::Reg16(R16::HL), IT::Reg16(cpu.bc(), R16::BC)),
            0x0A => Ld::new(ID::Reg8(R8::A), IT::PointedByReg16(gb.read(cpu.bc()), R16::BC)),
            0x0B => Dec::new(ID::Reg16(R16::BC)),
            0x0C => Inc::new(ID::Reg8(R8::C)),
            0x0D => Dec::new(ID::Reg8(R8::C)),
            0x0E => Ld::new(ID::Reg8(R8::C), IT::Imm8(gb.read(cpu.pc + 1))),
            0x0F => Rrca::new(),
            0x10 => Stop::new(),
            0x11 => Ld::new(ID::Reg16(R16::DE), IT::Imm16(gb.load(cpu.pc + 1))),
            ...
            0x16 => Ld::new(ID::Reg8(R8::D), IT::Imm8(gb.read(cpu.pc + 1))),
            ...
            0x1A => Ld::new(ID::Reg8(R8::A), IT::PointedByReg16(gb.read(cpu.de()), R16::DE)),
            0x1B => Dec::new(ID::Reg16(R16::DE)),
            0x1C => Inc::new(ID::Reg8(R8::E)),
            0x1D => Dec::new(ID::Reg8(R8::E)),
            0x1E => Ld::new(ID::Reg8(R8::E), IT::Imm8(gb.read(cpu.pc + 1))),
            0x1F => Rra::new(cpu.carry()),
            0x20 => Jr::new(IT::JumpToImm8(JC::NotZero(cpu.not_zero()), gb.read(cpu.pc + 1))),
            0x21 => Ld::new(ID::Reg16(R16::HL), IT::Imm16(gb.load(cpu.pc + 1))),
            ...
            0x3A => Ld::new(ID::Reg8(R8::A), IT::PointedByHLD(gb.read(cpu.hl()))),
            0x3B => Dec::new(ID::StackPointer),
            0x3C => Inc::new(ID::Reg8(R8::A)),
            0x3D => Dec::new(ID::Reg8(R8::A)),
            0x3E => Ld::new(ID::Reg8(R8::A), IT::Imm8(gb.read(cpu.pc + 1))),
            ...
            0x46 => Ld::new(ID::Reg8(R8::B), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0x4E => Ld::new(ID::Reg8(R8::C), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0x56 => Ld::new(ID::Reg8(R8::D), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0x5E => Ld::new(ID::Reg8(R8::E), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0x66 => Ld::new(ID::Reg8(R8::H), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0x6E => Ld::new(ID::Reg8(R8::L), IT::PointedByHL(gb.read(cpu.hl()))),
            ...
            0xC6 => Add::new(ID::Reg8(R8::A), IT::Imm8(gb.read(cpu.pc + 1))),
            0xC7 => Rst::new(0x00),
            ...
            0xDF => Rst::new(0x18),
            0xE0 => Ldh::new(ID::PointedByA8(gb.read(cpu.pc + 1)), IT::Reg8(cpu.a, R8::A)),
            ...
            0xEA => Ld::new(ID::PointedByN16(gb.load(cpu.pc + 1)), IT::Reg8(cpu.a, R8::A)),
            ...
            0xEF => Rst::new(0x28),
            0xF0 => Ldh::new(ID::Reg8(R8::A), IT::PointedByA8(gb.read(cpu.pc + 1))),
            ...
            0xFA => Ld::new(ID::Reg8(R8::A), IT::PointedByN16(gb.load(cpu.pc + 1))),
            0xFB => Ei::new(),
