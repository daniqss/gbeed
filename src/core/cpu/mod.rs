    ...
    pub fn fetch(&'_ mut self, opcode: u8) -> Result<Box<dyn Instruction<'_> + '_>, InstructionError> {
        let instruction: Box<dyn Instruction> = match opcode {
            ...
            0x01 => Ld::new(
                ...
                IT::Imm16(self.bus.borrow().read_word(self.pc + 1)),
            ),
            0x02 => Ld::new(
            ...
            0x12 => Ld::new(
                ID::PointedByReg16(self.bus.clone(), self.de(), R16::DE),
                IT::Reg8(self.a, R8::A),
            ),
            ...
            0x22 => {
                let aa = self.a;
                Ld::new(
                    ID::PointedByHLI(self.bus.clone(), self.mut_hl()),
                    IT::Reg8(aa, R8::A),
                )
            }
            ...
            0x32 => {
                let aa = self.a;
                Ld::new(
                    ID::PointedByHLD(self.bus.clone(), self.mut_hl()),
                    IT::Reg8(aa, R8::A),
                )
            }
